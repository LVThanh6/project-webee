...
document.querySelector('header').innerHTML = `
            ...
            <div class="header--right">
                <ul class="header__nav nav">
                    ...
                    <li class="nav__link" id = "link2"><a href="../page/featured/featured.html">Nổi bật</a></li>
                    <li class="nav__link" id = "link3"><a href="../page/blogs/blogs.html">Blog</a></li>
                    <li class="nav__link" id = "link4"><a href="../page/contact/contact.html">Liên hệ</a></li>
                </ul>
