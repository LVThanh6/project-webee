...
const menu_btn = document.querySelector(".btn_menu");
let menu_btn_can_click = true;
const nav = document.querySelector("#nav");
let show_menu = false;
menu_btn.addEventListener('click', function () {
    if (show_menu && menu_btn_can_click) {
        menu_btn_can_click = false;
        show_menu = false;
        nav.style.left = "-160px";
        setTimeout(() => {
            menu_btn_can_click = true;
    ...
    } else if (menu_btn_can_click) {
        menu_btn_can_click = false;
        show_menu = true;
        nav.style.display = "grid";
        nav.innerHTML = `
                    <li class="nav__link" id = "link0"><a>Trang chủ</a></li>
                    <li class="nav__link" id = "link1"><a href="../../index.html">Trang chủ</a></li>
                    <li class="nav__link" id = "link2"><a href="../../pages/featured/featured.html">Nổi bật</a></li>
                    <li class="nav__link" id = "link3"><a href="../../pages/blogs/blogs.html">Blog</a></li>
                    <li class="nav__link" id = "link4"><a href="../../pages/contact/contact.html">Liên hệ</a></li>
                    <li class="nav__link" id = "link5"><a>Đăng nhập</a></li>`
        setTimeout(() => {
            nav.style.left = "0%";
        }, 100);
        setTimeout(() => {
